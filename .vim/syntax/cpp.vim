...
syn keyword cppType		inline virtual explicit export bool wchar_t string
...
syn keyword cppStructure	class typename template namespace CORBA iterator const_iterator
...
"hi cClassName cterm=bold ctermfg=CYAN
hi def link cClassName String
...
syn match cpriortyperator       display "(\|)\|\[\|\]\|{\|}"
